...
void VelCovGeodetic__rosidl_typesupport_introspection_c__VelCovGeodetic_init_function(
...
void VelCovGeodetic__rosidl_typesupport_introspection_c__VelCovGeodetic_fini_function(void * message_memory)
{
  septentrio_gnss_driver__msg__VelCovGeodetic__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember VelCovGeodetic__rosidl_typesupport_introspection_c__VelCovGeodetic_message_member_array[14] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers VelCovGeodetic__rosidl_typesupport_introspection_c__VelCovGeodetic_message_members = {
  ...
  VelCovGeodetic__rosidl_typesupport_introspection_c__VelCovGeodetic_message_member_array,  // message members
  VelCovGeodetic__rosidl_typesupport_introspection_c__VelCovGeodetic_init_function,  // function to initialize message memory (memory has to be allocated)
  VelCovGeodetic__rosidl_typesupport_introspection_c__VelCovGeodetic_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t VelCovGeodetic__rosidl_typesupport_introspection_c__VelCovGeodetic_message_type_support_handle = {
  0,
  &VelCovGeodetic__rosidl_typesupport_introspection_c__VelCovGeodetic_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, septentrio_gnss_driver, msg, VelCovGeodetic)() {
  VelCovGeodetic__rosidl_typesupport_introspection_c__VelCovGeodetic_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  VelCovGeodetic__rosidl_typesupport_introspection_c__VelCovGeodetic_message_member_array[1].members_ =
  ...
  if (!VelCovGeodetic__rosidl_typesupport_introspection_c__VelCovGeodetic_message_type_support_handle.typesupport_identifier) {
    VelCovGeodetic__rosidl_typesupport_introspection_c__VelCovGeodetic_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &VelCovGeodetic__rosidl_typesupport_introspection_c__VelCovGeodetic_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
