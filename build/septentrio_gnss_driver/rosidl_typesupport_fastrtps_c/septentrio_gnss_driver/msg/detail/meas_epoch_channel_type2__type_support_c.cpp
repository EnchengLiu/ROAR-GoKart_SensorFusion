...
static size_t _MeasEpochChannelType2__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_septentrio_gnss_driver__msg__MeasEpochChannelType2(
    full_bounded, 0);
}
