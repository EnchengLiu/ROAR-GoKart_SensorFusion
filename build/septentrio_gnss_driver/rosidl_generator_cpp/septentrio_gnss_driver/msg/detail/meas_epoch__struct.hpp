...
struct MeasEpoch_
{
  ...
  using _type1_type =
    std::vector<septentrio_gnss_driver::msg::MeasEpochChannelType1_<ContainerAllocator>, typename ContainerAllocator::template rebind<septentrio_gnss_driver::msg::MeasEpochChannelType1_<ContainerAllocator>>::other>;
  _type1_type type1;
  ...
  Type & set__type1(
    const std::vector<septentrio_gnss_driver::msg::MeasEpochChannelType1_<ContainerAllocator>, typename ContainerAllocator::template rebind<septentrio_gnss_driver::msg::MeasEpochChannelType1_<ContainerAllocator>>::other> & _arg)
  {
    this->type1 = _arg;
    return *this;
  }
