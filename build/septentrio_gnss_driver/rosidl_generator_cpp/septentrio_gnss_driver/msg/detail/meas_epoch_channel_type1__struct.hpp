...
struct MeasEpochChannelType1_
{
  ...
  _n2_type n2;
  using _type2_type =
    std::vector<septentrio_gnss_driver::msg::MeasEpochChannelType2_<ContainerAllocator>, typename ContainerAllocator::template rebind<septentrio_gnss_driver::msg::MeasEpochChannelType2_<ContainerAllocator>>::other>;
  _type2_type type2;
  ...
  Type & set__type2(
    const std::vector<septentrio_gnss_driver::msg::MeasEpochChannelType2_<ContainerAllocator>, typename ContainerAllocator::template rebind<septentrio_gnss_driver::msg::MeasEpochChannelType2_<ContainerAllocator>>::other> & _arg)
  {
    this->type2 = _arg;
    return *this;
  }
