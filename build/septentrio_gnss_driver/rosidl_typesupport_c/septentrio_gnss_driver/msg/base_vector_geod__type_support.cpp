...
static const _BaseVectorGeod_type_support_symbol_names_t _BaseVectorGeod_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, septentrio_gnss_driver, msg, BaseVectorGeod)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, septentrio_gnss_driver, msg, BaseVectorGeod)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, septentrio_gnss_driver, msg, BaseVectorGeod)() {
  return &::septentrio_gnss_driver::msg::rosidl_typesupport_c::BaseVectorGeod_message_type_support_handle;
}
