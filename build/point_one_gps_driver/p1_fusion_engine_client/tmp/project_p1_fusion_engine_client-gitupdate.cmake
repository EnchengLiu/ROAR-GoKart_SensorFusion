...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/PointOneNav/fusion-engine-client.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/openark/ros2_ws/build/point_one_gps_driver/p1_fusion_engine_client/src/project_p1_fusion_engine_client/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/openark/ros2_ws/build/point_one_gps_driver/p1_fusion_engine_client/src/project_p1_fusion_engine_client/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
