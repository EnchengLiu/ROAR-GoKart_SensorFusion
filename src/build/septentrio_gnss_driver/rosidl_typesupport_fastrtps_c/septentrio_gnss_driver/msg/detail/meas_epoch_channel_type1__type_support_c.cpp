  ...
  void * untyped_ros_message)
{
  ...
  // Field name: type2
  {
    ...
    if (!septentrio_gnss_driver__msg__MeasEpochChannelType2__Sequence__init(&ros_message->type2, size)) {
      return "failed to create array for field 'type2'";
    }
    auto array_ptr = ros_message->type2.data;
    for (size_t i = 0; i < size; ++i) {
...
static size_t _MeasEpochChannelType1__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_septentrio_gnss_driver__msg__MeasEpochChannelType1(
    full_bounded, 0);
}
