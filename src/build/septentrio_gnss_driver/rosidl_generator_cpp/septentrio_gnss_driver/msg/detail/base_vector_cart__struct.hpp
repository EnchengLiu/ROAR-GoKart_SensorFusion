...
struct BaseVectorCart_
{
  ...
  using _vector_info_cart_type =
    std::vector<septentrio_gnss_driver::msg::VectorInfoCart_<ContainerAllocator>, typename ContainerAllocator::template rebind<septentrio_gnss_driver::msg::VectorInfoCart_<ContainerAllocator>>::other>;
  ...
  Type & set__vector_info_cart(
    const std::vector<septentrio_gnss_driver::msg::VectorInfoCart_<ContainerAllocator>, typename ContainerAllocator::template rebind<septentrio_gnss_driver::msg::VectorInfoCart_<ContainerAllocator>>::other> & _arg)
  {
