...
void MeasEpochChannelType1__rosidl_typesupport_introspection_c__MeasEpochChannelType1_init_function(
...
void MeasEpochChannelType1__rosidl_typesupport_introspection_c__MeasEpochChannelType1_fini_function(void * message_memory)
{
  septentrio_gnss_driver__msg__MeasEpochChannelType1__fini(message_memory);
}

size_t MeasEpochChannelType1__rosidl_typesupport_introspection_c__size_function__MeasEpochChannelType2__type2(
...
const void * MeasEpochChannelType1__rosidl_typesupport_introspection_c__get_const_function__MeasEpochChannelType2__type2(
...
void * MeasEpochChannelType1__rosidl_typesupport_introspection_c__get_function__MeasEpochChannelType2__type2(
...
bool MeasEpochChannelType1__rosidl_typesupport_introspection_c__resize_function__MeasEpochChannelType2__type2(
...
static rosidl_typesupport_introspection_c__MessageMember MeasEpochChannelType1__rosidl_typesupport_introspection_c__MeasEpochChannelType1_message_member_array[13] = {
  {
    "rx_channel",  // name
  ...
  },
  {
    ...
    NULL,  // default value
    MeasEpochChannelType1__rosidl_typesupport_introspection_c__size_function__MeasEpochChannelType2__type2,  // size() function pointer
    MeasEpochChannelType1__rosidl_typesupport_introspection_c__get_const_function__MeasEpochChannelType2__type2,  // get_const(index) function pointer
    MeasEpochChannelType1__rosidl_typesupport_introspection_c__get_function__MeasEpochChannelType2__type2,  // get(index) function pointer
    MeasEpochChannelType1__rosidl_typesupport_introspection_c__resize_function__MeasEpochChannelType2__type2  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers MeasEpochChannelType1__rosidl_typesupport_introspection_c__MeasEpochChannelType1_message_members = {
  ...
  MeasEpochChannelType1__rosidl_typesupport_introspection_c__MeasEpochChannelType1_message_member_array,  // message members
  MeasEpochChannelType1__rosidl_typesupport_introspection_c__MeasEpochChannelType1_init_function,  // function to initialize message memory (memory has to be allocated)
  MeasEpochChannelType1__rosidl_typesupport_introspection_c__MeasEpochChannelType1_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t MeasEpochChannelType1__rosidl_typesupport_introspection_c__MeasEpochChannelType1_message_type_support_handle = {
  0,
  &MeasEpochChannelType1__rosidl_typesupport_introspection_c__MeasEpochChannelType1_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, septentrio_gnss_driver, msg, MeasEpochChannelType1)() {
  MeasEpochChannelType1__rosidl_typesupport_introspection_c__MeasEpochChannelType1_message_member_array[12].members_ =
  ...
  if (!MeasEpochChannelType1__rosidl_typesupport_introspection_c__MeasEpochChannelType1_message_type_support_handle.typesupport_identifier) {
    MeasEpochChannelType1__rosidl_typesupport_introspection_c__MeasEpochChannelType1_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &MeasEpochChannelType1__rosidl_typesupport_introspection_c__MeasEpochChannelType1_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
