...
struct RFStatus_
{
  ...
  _flags_type flags;
  using _rfband_type =
    std::vector<septentrio_gnss_driver::msg::RFBand_<ContainerAllocator>, typename ContainerAllocator::template rebind<septentrio_gnss_driver::msg::RFBand_<ContainerAllocator>>::other>;
  _rfband_type rfband;
  ...
  Type & set__rfband(
    const std::vector<septentrio_gnss_driver::msg::RFBand_<ContainerAllocator>, typename ContainerAllocator::template rebind<septentrio_gnss_driver::msg::RFBand_<ContainerAllocator>>::other> & _arg)
  {
    this->rfband = _arg;
    return *this;
  }
