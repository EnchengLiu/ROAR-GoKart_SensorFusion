...
void ExtSensorMeas__rosidl_typesupport_introspection_c__ExtSensorMeas_init_function(
...
void ExtSensorMeas__rosidl_typesupport_introspection_c__ExtSensorMeas_fini_function(void * message_memory)
{
  septentrio_gnss_driver__msg__ExtSensorMeas__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ExtSensorMeas__rosidl_typesupport_introspection_c__ExtSensorMeas_message_member_array[22] = {
  {
    "header",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers ExtSensorMeas__rosidl_typesupport_introspection_c__ExtSensorMeas_message_members = {
  "septentrio_gnss_driver__msg",  // message namespace
  "ExtSensorMeas",  // message name
  22,  // number of fields
  sizeof(septentrio_gnss_driver__msg__ExtSensorMeas),
  ExtSensorMeas__rosidl_typesupport_introspection_c__ExtSensorMeas_message_member_array,  // message members
  ExtSensorMeas__rosidl_typesupport_introspection_c__ExtSensorMeas_init_function,  // function to initialize message memory (memory has to be allocated)
  ExtSensorMeas__rosidl_typesupport_introspection_c__ExtSensorMeas_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t ExtSensorMeas__rosidl_typesupport_introspection_c__ExtSensorMeas_message_type_support_handle = {
  0,
  &ExtSensorMeas__rosidl_typesupport_introspection_c__ExtSensorMeas_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, septentrio_gnss_driver, msg, ExtSensorMeas)() {
  ExtSensorMeas__rosidl_typesupport_introspection_c__ExtSensorMeas_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
  ExtSensorMeas__rosidl_typesupport_introspection_c__ExtSensorMeas_message_member_array[1].members_ =
  ...
  if (!ExtSensorMeas__rosidl_typesupport_introspection_c__ExtSensorMeas_message_type_support_handle.typesupport_identifier) {
    ExtSensorMeas__rosidl_typesupport_introspection_c__ExtSensorMeas_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &ExtSensorMeas__rosidl_typesupport_introspection_c__ExtSensorMeas_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
